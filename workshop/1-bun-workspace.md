...
คือ ฟีเจอร์ที่ช่วยให้เราสามารถจัดการ หลายๆ โปรเจกต์ (เช่น หน้าบ้าน และ หลังบ้าน) รวมไว้ในโฟลเดอร์ (Repository) เดียวกันได้ โดยใช้ Bun เป็นตัวบริหารจัดการ  
